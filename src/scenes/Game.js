...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        // Zkusíme nastavit offset s malým zpožděním a explicitním this
        this.time.delayedCall(10, () => {
            if (this.chlapik && this.chlapik.body) { // Přidali jsme kontrolu existence
                this.chlapik.body.offsetX = -1;
                this.chlapik.body.offsetY = -1;
        ...
        }, [], this); // Přidali jsme prázdné pole args a this jako callbackScope
